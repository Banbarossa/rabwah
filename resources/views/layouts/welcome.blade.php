...
{{--       wire:navigate>--}}
{{--        <img src="{{asset('apple-touch-icon.png')}}" alt="icon" class="w-10">--}}
{{--    </a>--}}
...
{{--                    </svg>--}}
{{--                    <img src="{{asset('apple-touch-icon.png')}}" class="w-10 h-10 object-cover mr-3" alt="logo"/>--}}
...
{{--                            </svg>--}}
{{--                        </div>--}}
{{--                        <div>Jl. Krueng Jreu, Gampong Krueng Lamkareung Kecamatan Indrapuri Kabupaten Aceh Besar, Aceh ---}}
{{--                            Indonesia 23363--}}
{{--                        </div>--}}
{{--                    </li>--}}
...
{{--                        </svg>--}}
{{--                        <a href="mailto:pesantrenarrabwah@gmail.com" class="hover:text-white">pesantrenarrabwah@gmail.com</a>--}}
{{--                    </li>--}}
{{--                    <li class="flex items-center">--}}
{{--                        <svg class="w-5 h-5 mr-3 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">--}}
{{--                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"--}}
...
{{--                        </svg>--}}
{{--                        <a href="tel:+6285167932929" class="hover:text-white">+62 851 6793 2929</a>--}}
{{--                    </li>--}}
{{--                </ul>--}}
{{--            </div>--}}
{{--        </div>--}}
