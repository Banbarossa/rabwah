<div>
    ...
    <div>
        <div class="flex">
            ...
            <flux:spacer/>
            <flux:button variant="primary"  wire:navigate href="{{route('pengaturan.galeri-slider.form')}}">Tambah
            </flux:button>
        </div>
        <div class="mt-8">
            <x-table.container>
                    ...
                    @forelse($this->medias as $index => $media)
                        <x-table.row variant="hovered" >
                            ...
                            <x-table.cell align="right">
                                <flux:button icon="eye" size="sm" :href="route('pengaturan.galeri-slider.form',['media_asset'=>$media->id])"
